...
class Main extends StatefulWidget {
  @override
  _CovitVirusState createState() => _CovitVirusState();
}

class _CovitVirusState extends State<Main> {
...
/*class FavoritesPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Paginas Favoritas')),
      body: ListView(
          children: favorites
              .map((url) => ListTile(
...
*/
  navigate(BuildContext context, WebViewController controller,
    ...
    if (canNavigate) {
      ...
      Scaffold.of(context).showSnackBar(
        SnackBar(
            content: Text("No ${goBack ? 'back' : 'forward'} Historial item")),
      );
    }
  }
}